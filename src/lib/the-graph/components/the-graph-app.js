/**
 * @file the-graph-app.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-app component
 * @date 24/07/2022
 *
...
function register(context) {
    ...
    class TheGraphApp extends React.Component {
    ...
    TheGraph.App = React.createElement.bind(null, TheGraphApp);
};
