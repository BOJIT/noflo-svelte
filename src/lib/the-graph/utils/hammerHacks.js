...
import HammerProto from './hammer_es6';

let Hammer = undefined;
let HammerHacks = undefined;

/*------------------------------ Implementation ------------------------------*/

if(typeof window !== 'undefined') {
    Hammer = HammerProto(window, document, 'es6');
