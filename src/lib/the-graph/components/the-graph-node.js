/**
 * @file the-graph-node.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-node component
 * @date 24/07/2022
 *
...
function register(context) {
  ...
  // Node view
  class TheGraphNode extends React.Component {
  ...
  TheGraph.Node = React.createElement.bind(null, TheGraphNode);
};
