/**
 * @file the-graph-node-menu-port.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-node-menu-port component
 * @date 24/07/2022
 *
...
function register(context) {
  ...
  class TheGraphNodeMenuPort extends React.Component {
  ...
  TheGraph.NodeMenuPort = React.createElement.bind(null, TheGraphNodeMenuPort);
};
