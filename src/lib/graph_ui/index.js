...
TheGraph.thumb = require('./the-graph-thumb/the-graph-thumb.js.js');

TheGraph.nav = require('./the-graph-nav/the-graph-nav.js.js');

TheGraph.autolayout = require('./the-graph/the-graph-autolayout.js');
TheGraph.library = require('./the-graph/the-graph-library.js');

TheGraph.clipboard = require('./the-graph-editor/clipboard.js.js');
