/**
 * @file the-graph-node-menu-ports.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-node-menu-ports component
 * @date 24/07/2022
 *
...
function register(context) {
  ...
  class TheGraphNodeMenuPorts extends React.Component {
  ...
  TheGraph.NodeMenuPorts = React.createElement.bind(null, TheGraphNodeMenuPorts);
};
