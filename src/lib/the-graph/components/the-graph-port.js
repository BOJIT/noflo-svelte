/**
 * @file the-graph-port.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-port component
 * @date 24/07/2022
 *
...
function register(context) {
  ...
  // Port view
  class TheGraphPort extends React.Component {
  ...
  TheGraph.Port = React.createElement.bind(null, TheGraphPort);
