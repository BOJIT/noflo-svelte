/**
 * @file the-graph-graph.js
 * @author James Bennion-Pedley
 * @brief ES6 port of the-graph-graph component
 * @date 24/07/2022
 *
...
function register(context) {
  ...
  // Graph view
  class TheGraphGraph extends React.Component {
  ...
  TheGraph.Graph = React.createElement.bind(null, TheGraphGraph);
};
